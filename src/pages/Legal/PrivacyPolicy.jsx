...
const PrivacyPolicy = () => {
    ...
    return (
        <div className="tool-container legal-page-wrapper">
            <ToolHeader
                title="Privacy Policy"
                subtitle={`Last Updated: ${updateDate}`}
            />
            ...
            <div className="tool-card legal-card">
                <div className="legal-content">
                    ...
                    <section>
                        ...
                        <ul>
                            <li><strong>Local Processing:</strong> Many tools process data directly in your browser using JavaScript, meaning your files never even leave your device.</li>
                            <li><strong>Temporary Servers:</strong> If a tool requires server-side processing, files are transmitted via encrypted connection (HTTPS) and automatically deleted from our servers the moment your download is complete.</li>
                        </ul>
                    </section>
